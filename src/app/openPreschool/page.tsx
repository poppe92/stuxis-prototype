...
function openPreschool() {
  return (
    <>
      ...
      <div className="flex flex-col w-full md:items-center md:justify-center text-xl">
        ...
        <Image
          ...
          placeholder="blur"
          className="lg:w-1/2 lg:p-2 px-10 flex flex-col justify-center"
        />
        ...
        <p className="lg:w-1/2 w-full px-10 lg:p-2 ">
          Följ oss på
          <Link
