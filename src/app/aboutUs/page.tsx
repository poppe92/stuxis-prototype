...
function aboutUs() {
  return (
    <>
      ...
      <div
        id="board"
        className="flex flex-col justify-center items-center text-xl lg:px-24 px-10 py-4">
      ...
      {/* Image Container Div */}
      <div className="flex w-full justify-center lg:items-center gap-10 lg:px-24 px-10 flex-wrap">
        {/* President */}
        <div>
          <Image
            src={imgJesper}
      ...
      {/* History Div */}
      <div className="flex flex-col justify-center items-center text-xl lg:px-24 px-10">
        <h1 className="text-xl font-bold text-comfy-blue underline decoration-light-comfy-red decoration-4 p-2 w-full lg:w-2/3">
          Historia
        </h1>
        <p className="w-full lg:w-2/3 p-2">
