...
// import images
import img1 from "/public/Stuxis_Logo-removebg-preview.webp";
  ...
  return (
    <>
      <main className="flex flex-col items-center justify-between ">
        ...
        <div className="flex flex-col w-full lg:items-center md:justify-center text-xl px-10 lg:px-0">
          <p className="lg:w-1/2 p-2 ">
            Stuxis är en ideellt driven förening som drivs av Föräldraföreningen
            i Stuxbergsgatans Fritidspark.
          </p>
          ...
          <Image
            ...
            alt="/"
            placeholder="blur"
            className="flex lg:w-1/2 p-2 justify-center"
          />
          ...
          <p className="lg:w-1/2 p-2 ">
            ...
            massor av roliga utomhusleksaker för alla åldrar. I parken finns
            även en stor låda med sandlådeleksaker som man får låna som icke
            medlem. roliga
          </p>
        ...
        {/* Latest News */}
        <div className="flex flex-col items-center text-xl w-full px-10 lg:px-0">
          ...
          <div className="lg:w-1/2">
            ...
            <p>
              Vill du vara med på filtloppis, ta med en egen filt och skriv ut
              ett swishnummer, vi har inte möjlighet att bistå med det.
            </p>
            <p>
              Alla medlemmar är välkomna! Är du inte medlem? Bli medlem idag
              eller på plats!
            </p>
          </div>
        </div>
